        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventIntroduction = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    EventLocation = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ...
                    UpdatedByUser = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ContactEmail = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ContactInfo = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    RegisterUrl = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ShowWelcomeText = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenForRegistration = table.Column<bool>(type: "bit", nullable: false),
                    IsVisibleToUser = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SectionDisplayNumber = table.Column<int>(type: "int", nullable: false),
                    SectionHeader = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    SectionBody = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    HyperLink = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    HyperLinkHeader = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoryHeading = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ActiveStory = table.Column<bool>(type: "bit", nullable: false),
                    PublicStory = table.Column<bool>(type: "bit", nullable: false),
                    StoryCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccommodationWith = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Allergies = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserInformation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AgreeToSavePersonalData = table.Column<bool>(type: "bit", nullable: false),
                    Confirmed = table.Column<bool>(type: "bit", nullable: false),
                    EventId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMeetingRegistrationForms", x => x.Id);
                    table.ForeignKey(
